...
public class OrderController {
    ...
    @PostMapping("/pay")
    public ResponseEntity<Order>  createOrder(@RequestBody List<ProductRequestDto> productList) {
        // TODO 사용자 토큰으로 userId 추출
        return ResponseEntity.ok(new Order(1, "1", 55000, 0, 0, 55000, new Timestamp(System.currentTimeMillis()), new Timestamp(System.currentTimeMillis())));
    }
}
